...
let globalStorage = {}
let sign = vscode.commands.registerCommand('digital-signing.sign',async function () {
let funcName = "sign"; let pyVar = "python";
...
context.subscriptions.push(sign);
let verify = vscode.commands.registerCommand('digital-signing.verify',async function () {
let funcName = "verify"; let pyVar = "python";
        let py = spawn(pyVar, [pythonPath, funcName]);
...
let generateKeyPair = vscode.commands.registerCommand('digital-signing.generateKeyPair',async function () {
let funcName = "generate_key_pair"; let pyVar = "python";
        let py = spawn(pyVar, [pythonPath, funcName]);
...
context.subscriptions.push(generateKeyPair);
}
